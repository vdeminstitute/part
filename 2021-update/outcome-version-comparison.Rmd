...
The v9 and v11 versions of the RoW change data range jointly from 1970 to 2019. The v9 version has 189 negative RoW changes in that period; v11 has 160. Furthermore, the sets of cases identified are quite different:

```{r}
table(v9 = both$v9pos, v11 = both$v11pos)
```

Only 120 cases are identified in both. The v9 data has 66 changes that are not in v11 and vice versa there are 30 in v11 that are not in v9. 
