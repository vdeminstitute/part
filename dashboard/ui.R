          ...
          wellPanel(
            ...
            h3(
              tags$span(
                ...
                style = "font-size: 80%; color: black;", "The PART project uses data from the", a(href= "https://www.v-dem.net", "Varieties of Democracy (V-Dem)", target="_blank"), "Institute and other sources to estimate the risk of adverse regime transitions during the next", tags$b("two years (2019-2020)."),
                br(),
                br(),
